...
public class ShowDataKabaActivity extends AppCompatActivity {
    ...
    private TextView ktime,klad,kposte,kcomponent,kvariante,kquantity;
    private String slad,sposte,scomponent,squantity,svariante,stime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stime = getIntent().getExtras().get("val6").toString();
